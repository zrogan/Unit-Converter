//
//  TableViewControllerMedidas.swift
//  Unit Converter
//
...
class TableViewControllerMedidas: UITableViewController, origensDelegate {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("cellMedidas", forIndexPath: indexPath)
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "medidasOrigem"{
            ...
            nextView.medida = table.textLabel?.text
