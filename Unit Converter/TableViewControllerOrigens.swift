//
//  TableViewControllerOrigens.swift
//  Unit Converter
//
...
protocol origensDelegate {
}

class TableViewControllerOrigens: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("cellOrigem", forIndexPath: indexPath)
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "origemDestino" {
            let nextView = segue.destinationViewController as! TableViewControllerDestinos
            nextView.medida = self.medida
            nextView.medidas = self.medidas
            let table : UITableViewCell = sender as! UITableViewCell
            nextView.origem = table.textLabel?.text
        }
    }
